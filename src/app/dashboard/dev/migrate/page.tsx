...
import DevMigrateForm from "./DevMigrateForm";
...
export default async function DevMigratePage() {
  if (!isPageEnabled()) {
    notFound();
  }
  ...
  if (!userId) {
    return (
      <div className="min-h-screen p-6 max-w-3xl mx-auto">
        <h1 className="text-3xl font-semibold mb-2">Dev Migration Runner</h1>
  ...
  return (
    <div className="min-h-screen p-6 max-w-3xl mx-auto" data-testid="dev-migrate-page">
      <h1 className="text-3xl font-semibold mb-2">Dev Migration Runner</h1>
      <p className="text-zinc-600 mb-6">Run preview database migrations without DevTools.</p>
      <DevMigrateForm />
    </div>
  );
}
