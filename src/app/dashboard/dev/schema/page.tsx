...
import DevSchemaForm from "./DevSchemaForm";
...
export default async function DevSchemaPage() {
  if (!isPageEnabled()) notFound();
  ...
  if (!userId) {
    return (
      <div className="min-h-screen p-6 max-w-3xl mx-auto">
        <h1 className="text-3xl font-semibold mb-2">Dev Schema Diagnostics</h1>
  ...
  return (
    <div className="min-h-screen p-6 max-w-3xl mx-auto" data-testid="dev-schema-page">
      <h1 className="text-3xl font-semibold mb-2">Dev Schema Diagnostics</h1>
      <p className="text-zinc-600 mb-6">Canonical Gate 12 diagnostics for preview validation.</p>
      <DevSchemaForm />
    </div>
  );
}
