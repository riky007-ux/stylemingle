  ...
  "tshirt-basic": (
    <>
      ...
      <g id="top">
        ...
        <rect x={65} y={120} width={70} height={75} rx={14} fill="none" stroke="#000" strokeOpacity={0.05} />
      </g>
    </>
  ),
};
...
export const avatarBottoms: Record<AvatarBottomKey, ReactElement> = {
  "jeans-basic": (
    <>
      ...
      <g id="bottom">
        {/* left pant leg */}
        <rect x={75} y={190} width={20} height={75} rx={4} fill="url(#jeans-basic-fill)" />
        <rect x={75} y={190} width={20} height={75} rx={4} fill="url(#jeans-basic-highlight)" />
        <rect x={75} y={190} width={20} height={75} rx={4} fill="none" stroke="#000" strokeOpacity={0.05} />
        {/* right pant leg */}
        <rect x={105} y={190} width={20} height={75} rx={4} fill="url(#jeans-basic-fill)" />
        <rect x={105} y={190} width={20} height={75} rx={4} fill="url(#jeans-basic-highlight)" />
        <rect x={105} y={190} width={20} height={75} rx={4} fill="none" stroke="#000" strokeOpacity={0.05} />
      </g>
    </>
  ),
};
