...
export const avatarBottoms: Record<string, Record<AvatarSize, React.ReactNode>> = {
  'jeans-basic': {
    S: <rect x={80} y={200} width={40} height={160} fill="#3465A4" />, 
    M: <rect x={75} y={200} width={50} height={160} fill="#3465A4" />, 
    L: <rect x={70} y={200} width={60} height={160} fill="#3465A4" />, 
    XL: <rect x={65} y={200} width={70} height={160} fill="#3465A4" />,
  },
};
